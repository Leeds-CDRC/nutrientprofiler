#' Example dataset called CDRC Drinks
#'
#' A handcrafted set of data that can be used as the input for
#' nutrientprofiler functions
#'
#' @format `cdrcdrinks` ##
#' A data frame of 10 rows and 21 columns:
#' \describe{
#'   \item{name}{Name of product}
#'   \item{brand}{Brand of product}
#'   \item{product_category}{Category of product}
#'   \item{product_type}{Type of product, i.e. Food or Drink}
#'   \item{food_type}{Type of food, used for specific gravity conversion}
#'   \item{drink_format}{Format of drink, used for specific gravity conversion}
#'   \item{drink_type}{Type of drink, used for speciifc gravity conversion}
#'   \item{nutrition_info}{How nutritional information is presented, for specific gravity conversion}
